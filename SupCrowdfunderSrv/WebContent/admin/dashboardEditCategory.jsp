...
<html>
	<head>
		...
		<title>SupCrowdfunder - Modifier la catégorie</title>
	</head>
	<body>
		...
		<div class="span9">
			<div class="border">
				...
				<form action="<%= request.getContextPath() %>/admin/dashboardEditCategory" method="post">
					<p>
						<label for="name">Changer de nom :</label>
							<input type="text" size="40" name="name" id="name" /> (Nom actuel : ${category.name})
					</p>
					<p>
